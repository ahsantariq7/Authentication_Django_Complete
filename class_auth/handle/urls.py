...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(redirect_authenticated_user=True, template_name='registration/login.html',success_url = 'home'), name='login'),
    path('profile/<int:pk>',views.ProfileView.as_view(),name='profile'),
    path('accounts/profile/',views.OnlyProfileView.as_view(),name='profile_view'),
    path('logout/', auth_views.LogoutView.as_view(next_page='login'), name='logout'),
    # Change Password
    path('change-password/',auth_views.PasswordChangeView.as_view(template_name='registration/password_change.html',success_url = 'change'),name='change_password'),
    path('change-password/change/',views.PasswordChangedView.as_view(),name='change_password_success'),
    # Forget Password
    path('password-reset/',
         auth_views.PasswordResetView.as_view(template_name='password-reset/password_reset.html',subject_template_name='password-reset/password_reset_subject.txt',email_template_name='password-reset/password_reset_email.html',success_url='/login/'),name='password_reset'),
